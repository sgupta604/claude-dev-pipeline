...
## Steps
1. Launch agent: "Quick fix: '$ARGUMENTS'. Verify this is small (< 3 files), obvious, and low-risk. If not, STOP and say 'needs full pipeline'. If yes, fix it, run tests (pnpm test + pytest), report results."
